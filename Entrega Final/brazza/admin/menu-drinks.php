...
<head>
  ...
  <title>Bebidas – Panel Admin</title>
...
<body>
  ...
  <div class="admin-wrap">
    <h1 class="admin-page-title">Bebidas</h1>
    <p class="admin-page-sub">Agregar, editar y eliminar bebidas del menú · <span style="color:#c8b89a;">* campos obligatorios</span></p>

    <form class="admin-form" action="../db/insertDrink.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
    ...
    <h2 class="admin-page-title" style="font-size:1.4rem; margin-bottom:20px;">Bebidas registradas</h2>
      ...
      <?php while($item = mysqli_fetch_array($result)) { ?>
        <div class="item-card">
          ...
          <div class="item-actions">
            <button class="btn-edit"   onclick="window.location.href='editDrink.php?id=<?php echo $item['id']; ?>'">Editar</button>
            <button class="btn-delete" onclick="confirmDelete('../db/deleteDrink.php?id=<?php echo $item['id']; ?>')">Eliminar</button>
          </div>
        </div>
      <?php } ?>
    </div>
